    ...
    return (
        <section id="book-one-ticket">
            <form onSubmit={handleSubmit}>
                <input type="email" name="email" id="email-input" value={formData.email} onChange={handleChange} />
                <input type="text" name="name" id="name-input" value={formData.name} onChange={handleChange} />
                <input type="text" name="phone" id="phone-input" value={formData.phone} onChange={handleChange} />
                <select name="paymentMethod" id="payment-method" value={formData.paymentMethod} onChange={handleChange}>
